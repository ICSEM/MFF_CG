...
if __name__ == '__main__':
    ...
    enc_inputs1 = enc_inputs[:532]
    # enc_inputs2 = enc_inputs[8:10]
    dec_inputs1 = dec_inputs[:532]
    # dec_inputs2 = dec_inputs[8:10]
    target_batch1 = target_batch[:532]
    ...
    for epoch in range(300):
        ...
        #     torch.save(model.state_dict(), 'save_model/HStrans_model1_4_400_300.pt')
        # print("该轮训练之后的最好损失为：", best_test_loss)

        # print("该轮数的结束时间：",end_time)
    # end_time1 = time.time()
    # spend_time = end_time1 - start_time1
    torch.save(model.state_dict(), 'save_model1/HStrans_model1_4_598_300.pt')
    ...
    with open('predict_source_code/HSoutput1_4_598_300.txt', 'w', encoding='utf-8') as f1:
        f1.write('')
    with open('predict_source_code/HSoutput1_target_4_598_300.txt', 'w', encoding='utf-8') as f2:
        f2.write('')
    ...
    for j in range(j1, len(sentences)):
        model.load_state_dict(torch.load('save_model1/HStrans_model1_4_598_300.pt'))
        ...
        str2 = sentences[j][2]
        with open('predict_source_code/HSoutput1_4_598_300.txt', 'a', encoding='utf-8') as f1:
            f1.write(str1)

            f1.write('\n')
        with open('predict_source_code/HSoutput1_target_4_598_300.txt', 'a', encoding='utf-8') as f2:
            f2.write(str2)
            f2.write('\n')
